  ...
  Widget build(BuildContext context) {
    ...
    Widget btn(String code, String label) {
      ...
      return TextButton(
        ...
        style: TextButton.styleFrom(foregroundColor: sel ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSurfaceVariant),
        child: Text(label, style: TextStyle(fontWeight: sel ? FontWeight.bold : FontWeight.normal)),
      );
    }
    return Row(mainAxisAlignment: MainAxisAlignment.end, children: [btn('en', 'EN'), btn('zh', '中文')]);
  }
}
