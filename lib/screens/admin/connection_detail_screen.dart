  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final results = await Future.wait([
        ...
        widget.api.get('/api/v1/admin/connections/$cid/health').catchError((_) => <String, dynamic>{}),
      ]);
      if (!mounted) return;
      setState(() {
        ...
        children: [
          Row(children: [
            ...
            Expanded(child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(_conn?['name']?.toString() ?? widget.connectionId,
          ...
          _infoRow('Type', _conn?['type']?.toString() ?? _conn?['connection_type']?.toString() ?? '—'),
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _infoRow('Latency', _health?['latency_ms']?.toString() != null
          ...
          if (_showConfig && _conn != null) ...[
            ...
            Container(
              ...
              child: SelectableText(
                _conn!.entries
                  .where((e) => !['id', 'name'].contains(e.key))
                  .map((e) => '${e.key}: ${e.value}')
                  .join('\n'),
