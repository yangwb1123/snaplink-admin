...
part 'dashboard_screen_navigation_view.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _initShortcuts() => _initShortcutsNavigation();

  void _localLogout() => _localLogoutNavigation();

  void _switchModuleByNumber(int index) =>
      _switchModuleByNumberNavigation(index);
